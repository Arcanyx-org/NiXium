...
# Module exporting configuration from KRYPTON to other systems
...
in mkMerge [
	{
		# SSHD on Onions
		# age.secrets.krypton-onion = {
		# 	file = ../secrets/krypton-onion.age;
		...
		# 	path = "/var/lib/tor/krypton-onion.conf";
		...
		# 	config.age.secrets."krypton-onion".path
		# ];
	}
]
