...
in {
	...
	# boot.impermanence.enable = true; # Use impermanence
		system.stateVersion = "25.11"; # Temporary til we handle impermenance
		age.identityPaths = [ "/etc/ssh/ssh_host_ed25519_key" ];

	boot.plymouth.enable = true;

	nix.distributedBuilds = false; # Whether to perform distributed builds
	...
	# age.secrets.enchilada-ssh-ed25519-private.file = ../secrets/enchilada-ssh-ed25519-private.age; # Declare private key
