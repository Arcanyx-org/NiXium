...
# ENCHILADA-specific configuration of OpenSSH

let
	inherit (lib) mkIf mkForce;
in mkIf config.services.openssh.enable {
	# Import the private key for an onion service
	# age.secrets.enchilada-onion-openssh-private = {
	# 	file = ../secrets/enchilada-onion-openssh-private.age;
	...
	# Set the pubkey
	# environment.etc."ssh/ssh_host_ed25519_key.pub".text = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIDhD5Fel4xaocToIQay3IkytHGaK93cDN52ww2Bw5Nj+ root@enchilada";
