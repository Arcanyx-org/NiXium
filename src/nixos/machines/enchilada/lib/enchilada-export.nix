...
# Module exporting configuration from ENCHILADA to other systems
...
in mkMerge [
	{
		# # SSHD on Onions
		# age.secrets.enchilada-onion = {
		# 	file = ../secrets/enchilada-onion.age;
		...
		# 	path = "/var/lib/tor/enchilada-onion.conf";
		...
		# 	config.age.secrets."enchilada-onion".path
		# ];
	}
]
