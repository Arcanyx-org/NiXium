...
in {
	...
	programs.ssh.knownHosts."localhost".publicKey = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAICZ2SsM9PkGXuiulbEFSRJhcs1Vq20L+4pr7DRRFxreb";
	...
	# Extending life of the SSD/eMMC
		services.fstrim.enable = true;

	age.secrets.hana-ssh-ed25519-private.file = ../secrets/hana-ssh-ed25519-private.age; # Declare private key
