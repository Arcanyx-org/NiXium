...
targetIP="192.168.0.165"
targetFlake="github:Arcanyx-org/NiXium/960e445f28a6c3fe86c2c9b7923c001ed6b4a6fc#nixos-mracek-stable"
...
# nix copy --to ssh://root@$targetIP "$(nix build "${targetFlake//#*/}#nixosConfigurations.\"nixos-mracek-stable\".config.system.build.toplevel" --print-out-paths || true)"
