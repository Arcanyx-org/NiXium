...
# Nix-based Disk Management of SKYCUT with disko and impermenance on tmpfs
...
let
	...
	diskoDevice = "/dev/disk/by-id/ata-Patriot_P210_128GB_P210EDBB210710000667";
	keyDevice = "/dev/disk/by-id/mmc-SA02G_0x272bcf2e";
	swapSize = "30G";
	impermanentSize = "5G";
in mkMerge [
	{
		age.secrets.skycut-disks-password.file = "${self.outPath}/src/nixos/machines/skycut/secrets/skycut-disks-password.age"; # Supply password for disk encryption
	}
						...
						boot = {
							...
							store = {
								...
								content = {
									...
									passwordFile = config.age.secrets.skycut-disks-password.path;
